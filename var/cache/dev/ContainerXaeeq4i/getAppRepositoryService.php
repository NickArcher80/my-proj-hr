...
// Returns the private 'App\Repository\AppRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AppRepository.php';

return $this->services['App\Repository\AppRepository'] = new \App\Repository\AppRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
