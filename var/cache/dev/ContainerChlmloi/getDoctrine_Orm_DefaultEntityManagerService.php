...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Repository\\AppRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\AppRepository']) ? $this->services['App\Repository\AppRepository'] : $this->load('getAppRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\ProductsRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\ProductsRepository']) ? $this->services['App\Repository\ProductsRepository'] : $this->load('getProductsRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\UsersRepository' => function () {
    return ${($_ = isset($this->services['App\Repository\UsersRepository']) ? $this->services['App\Repository\UsersRepository'] : $this->load('getUsersRepositoryService.php')) && false ?: '_'};
}])));
